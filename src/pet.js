(function exportPet() {
    ...
    Pet.prototype.growUp = function(){
        ...
        this.age += 1;
        this.hunger = Math.max(this.hunger += HUNGER_INCREASED_BY_GROWTH, MINIMUM_HUNGER);
        this.fitness = Math.max(this.fitness -= FITNESS_REDUCED_BY_GROWTH, MINIMUM_FITNESS);
    };
    ...
    Pet.prototype.walk = function(){
        ...
        this.fitness = Math.min(this.fitness += SMALL_FITNESS_INCREASE, MAXIMUM_FITNESS);
    }
    ...
    Pet.prototype.feedASnack = function(){
        ...
        this.hunger = Math.min(this.hunger -= HUNGER_INCREASED_BY_GROWTH, MAXIMUM_HUNGER);
    };
